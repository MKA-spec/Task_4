...
describe('AllPerks page (Directory)', () => {
  ...
  test('lists public perks and responds to merchant filtering', async () => {
    ...
    // Interact with the merchant filter dropdown
    // Since the select doesn't have proper label association, we can find it by its context
    const merchantFilterContainer = screen.getByText('Filter by Merchant').closest('div');
    const merchantFilter = merchantFilterContainer.querySelector('select');
